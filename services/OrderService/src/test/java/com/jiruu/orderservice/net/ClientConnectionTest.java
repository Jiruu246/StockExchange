...
class ClientConnectionTest {
    ...
    void send() throws IOException {
        try (DatagramSocket receiverSocket = new DatagramSocket(0)) {
            ...
            clientConnection.send(msg, InetAddress.getLocalHost(), port);
    ...
    void receive() throws IOException {
        final String expectedMulticastAdder = "230.0.0.1";
        final int expectedMulticastPort = 4447;

        clientConnection.joinGroup(
                new InetSocketAddress(
                        InetAddress.getByName(expectedMulticastAdder),
        ...
        try (DatagramSocket senderSocket = new DatagramSocket()) {
            ...
            DatagramPacket packet = new DatagramPacket(
                    ...
                    InetAddress.getByName(expectedMulticastAdder), expectedMulticastPort);
